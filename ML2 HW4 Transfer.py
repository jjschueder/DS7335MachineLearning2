# -*- coding: utf-8 -*-
"""
Created on Thu Mar 11 13:20:43 2021
...
(xl_train, xl_test, yl_train, yl_test) = train_test_split(X, Y, test_size=0.75, random_state=101)
yl_train = yl_train -1
yl_test = yl_test -1
...
(unique, counts) = np.unique(yl_test, return_counts=True)
...
first_array=np.array(xl_test[9254])
